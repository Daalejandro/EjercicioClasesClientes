...
public class HibernateQLClientes {
    public static void main(String[] args) {
        ...
        List<ClienteDto> clientesDto = em.createQuery("select new org.hibernate_jpa.dominio.ClienteDto(c.nombre, c.apellido) from Cliente c", ClienteDto.class)
                .getResultList();
